          ...
          <div className="glass-grid glass-grid-3">
            <div style={{ position: 'relative' }}>
              <input className="glass-input" placeholder="Бренд *" value={form.device.brand}
                ...
                onFocus={() => ac.handleCatalogInput('brand', form.device.brand)} onBlur={ac.hideSuggestions} required />
            ...
            <div style={{ position: 'relative' }}>
              <input className="glass-input" placeholder="Модель *" value={form.device.model}
                ...
                onFocus={() => ac.handleCatalogInput('model', form.device.model || form.device.brand)} onBlur={ac.hideSuggestions} required />
